<template>
    <div class="q-pa-none q-col-gutter-sm">
            ...
            <q-list :label="$t('wizard.tableOfContent.stepParts')">
              <q-item v-for="(item, itemIndex) in tocStep.items" :key="itemIndex">
                ...
                <q-item-section side top>
                  <q-btn flat icon="close" @click="removePart(stepIndex, itemIndex)" />
                </q-item-section>
              </q-item>
              <q-item>
                <q-item-section>
                  <q-btn flat :label="$t('wizard.tableOfContent.addPart')" @click="addPart(stepIndex)" />
                </q-item-section>
              </q-item>
            </q-list>
          </q-item-section>
      ...
      <div class="row">
        <q-btn class="col" flat :label="$t('wizard.tableOfContent.addStep')" @click="addStep" />
        <q-btn class="col" flat :label="$t('wizard.tableOfContent.addAIStep')" @click="$emit('generateTableOfContent')" />
      </div>
    </div>
